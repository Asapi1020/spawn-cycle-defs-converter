...
import { convertTXTToUC, convertUCToTXT, loadConfig } from "./usecase/fileSystem";

const config = loadConfig();
const program = new Command();

program.name("spawn-cycle-converter").description("Convert Spawn Cycle definitions between txt and uc formats");
